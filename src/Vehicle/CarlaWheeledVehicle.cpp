...
void ACarlaWheeledVehicle::BeginPlay()
{
  ...
  customVariable = 0.0f;  // Example initialization


  // Initialize the AugmentedRealityPath
  TArray<FVector> InitialAugmentedRealityPath;
  InitialAugmentedRealityPath.Add(FVector(100.0f, 200.0f, 0.0f));  // Example point 1
  InitialAugmentedRealityPath.Add(FVector(150.0f, 250.0f, 0.0f));  // Example point 2
  InitialAugmentedRealityPath.Add(FVector(200.0f, 300.0f, 0.0f));  // Example point 3

  SetAugmentedRealityPath(InitialAugmentedRealityPath);  // Set the initialized path
...
TArray<FVector> ACarlaWheeledVehicle::GetAugmentedRealityPath() const
{
    return InputControl.Control.AugmentedRealityPath;
}

void ACarlaWheeledVehicle::SetAugmentedRealityPath(const TArray<FVector>& NewPath)
{
    InputControl.Control.AugmentedRealityPath = NewPath;
}