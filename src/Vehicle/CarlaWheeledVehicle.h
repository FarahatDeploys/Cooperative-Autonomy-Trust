...
private:
  ...
  UPROPERTY(Category = "CARLA Wheeled Vehicle", EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "true"))
...
public:
  void SetAugmentedRealityPath(const TArray<FVector>& NewPath);
  TArray<FVector> GetAugmentedRealityPath() const;
